...
/**
 * Holds configuration data for the <code>&lt;datasource&gt;</code> tag
...
public class DataSourceElement
{
     ...
     * @return Cargo datasource object.
     */
    public DataSource createDataSource()
    {
        TransactionSupport tSupport = TransactionSupport.valueOf(transactionSupport);
        DataSource dataSource = new DataSource(jndiName, connectionType, tSupport, driverClass,
                url, username, password, id, connectionProperties);
        return dataSource;
    }
}
