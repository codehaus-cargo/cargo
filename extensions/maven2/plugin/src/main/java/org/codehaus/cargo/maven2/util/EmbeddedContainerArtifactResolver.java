...
public class EmbeddedContainerArtifactResolver
{
        ...
        ArtifactFactory artifactFactory)
    {
        ...
        jetty9xDependencies.add(new Dependency("org.eclipse.jetty.toolchain", "jetty-schemas",
            "3.1"));
        jetty9xDependencies.add(new Dependency("org.jboss.weld.servlet", "weld-servlet",
            "2.4.1.Final"));
        // annotations
        ...
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-annotations-api",
            "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "7.0.70"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "7.0.70"));
        ...
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-annotations-api",
            "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util-scan",
            "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "8.5.9"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "8.5.9"));
        ...
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-annotations-api",
            "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api",
            "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "9.0.0.M15"));
        ...
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina",
            "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "9.0.0.M15"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "9.0.0.M15"));
