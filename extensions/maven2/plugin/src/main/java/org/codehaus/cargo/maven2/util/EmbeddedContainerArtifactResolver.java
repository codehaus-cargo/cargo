...
public class EmbeddedContainerArtifactResolver
{
        ...
        ArtifactFactory artifactFactory)
    {
        ...
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api",
            "10.0.0-M8"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "10.0.0-M8"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "10.0.0-M8"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "10.0.0-M8"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "10.0.0-M8"));
