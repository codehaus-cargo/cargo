...
public class EmbeddedContainerArtifactResolver
{
        ...
        ArtifactFactory artifactFactory)
    {
        ...
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-annotations-api",
            "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "7.0.67"));
        tomcat7xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "7.0.67"));
        ...
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-annotations-api",
            "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util-scan",
            "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "8.0.30"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "8.0.30"));
