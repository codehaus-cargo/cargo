...
public class EmbeddedContainerArtifactResolver
{
        ...
        ArtifactFactory artifactFactory)
    {
        ...
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-annotations-api",
            "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api",
            "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "9.0.27"));
        ...
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina",
            "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "9.0.27"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "9.0.27"));
