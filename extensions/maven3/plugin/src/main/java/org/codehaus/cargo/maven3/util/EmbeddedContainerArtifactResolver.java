...
public class EmbeddedContainerArtifactResolver
{
        ...
        ProjectBuildingRequest projectBuildingRequest)
    {
        ...
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "jakartaee-migration", "shaded", "1.0.8"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-servlet-api", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-annotations-api", "11.0.0-M24"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-dbcp", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-el-api", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jsp-api", "11.0.0-M24"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "11.0.0-M24"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "11.0.0-M24"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "11.0.0-M24"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-catalina", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-coyote", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-client-api", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper", "11.0.0-M24"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "11.0.0-M24"));
        // To get to the actual ECJ version, open the MANIFEST.MF file in Tomcat's lib/ecj-xxx.jar
