...
public class EmbeddedContainerArtifactResolver
{
        ...
        ProjectBuildingRequest projectBuildingRequest)
    {
        ...
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "8.5.90"));
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-servlet-api", "8.5.90"));
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-annotations-api", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-dbcp", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "8.5.90"));
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "8.5.90"));
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "8.5.90"));
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "8.5.90"));
        tomcat8xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "8.5.90"));
        tomcat8xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "8.5.90"));
        ...
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-servlet-api", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-annotations-api", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-dbcp", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-catalina", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-client-api", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "10.1.10"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "10.1.10"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "10.1.10"));
        // To get to the actual ECJ version, open the MANIFEST.MF file in Tomcat's lib/ecj-xxx.jar
        ...
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-servlet-api", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-annotations-api", "11.0.0-M7"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-dbcp", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-el-api", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jsp-api", "11.0.0-M7"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "11.0.0-M7"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "11.0.0-M7"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "11.0.0-M7"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-catalina", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-coyote", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-client-api", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper", "11.0.0-M7"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "11.0.0-M7"));
        // To get to the actual ECJ version, open the MANIFEST.MF file in Tomcat's lib/ecj-xxx.jar
