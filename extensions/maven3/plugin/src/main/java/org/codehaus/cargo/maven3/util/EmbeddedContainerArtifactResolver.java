...
public class EmbeddedContainerArtifactResolver
{
        ...
        ProjectBuildingRequest projectBuildingRequest)
    {
        ...
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "9.0.100"));
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-servlet-api", "9.0.100"));
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-annotations-api", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-dbcp", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "9.0.100"));
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-catalina", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "9.0.100"));
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "9.0.100"));
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "9.0.100"));
        tomcat9xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "9.0.100"));
        tomcat9xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "9.0.100"));
        // To get to the actual ECJ version, open the MANIFEST.MF file in Tomcat's lib/ecj-xxx.jar
        ...
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "10.1.36"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "10.1.36"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "10.1.36"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "10.1.36"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-catalina", "10.1.36"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "10.1.36"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "10.1.36"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-client-api", "10.1.36"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "10.1.36"));
        tomcat10xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "10.1.36"));
        tomcat10xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "10.1.36"));
        // To get to the actual ECJ version, open the MANIFEST.MF file in Tomcat's lib/ecj-xxx.jar
        ...
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "jakartaee-migration", "shaded", "1.0.9"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-servlet-api", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-annotations-api", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-dbcp", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-el-api", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jaspic-api", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jsp-api", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-juli", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-api", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jni", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-util", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-util-scan", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-catalina", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-coyote", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-api", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket-client-api", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-websocket", "11.0.4"));
        tomcat11xDependencies.add(new Dependency("org.apache.tomcat", "tomcat-jasper", "11.0.4"));
        tomcat11xDependencies.add(
            new Dependency("org.apache.tomcat", "tomcat-jasper-el", "11.0.4"));
        // To get to the actual ECJ version, open the MANIFEST.MF file in Tomcat's lib/ecj-xxx.jar
