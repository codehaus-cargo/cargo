...
public abstract class JettyEmbeddedEE8ProfileTest extends AbstractJettyEmbeddedEEProfileTest
{
    ...
    public void testEE8Profile() throws Exception
    {
        ...
        String simpleWar = getTestData().getTestDataFileFor("simple-war");
        WAR war = (WAR) this.createDeployable(
            simpleWar.replace("/deployables-jakarta-ee/", "/deployables/"), DeployableType.WAR);
