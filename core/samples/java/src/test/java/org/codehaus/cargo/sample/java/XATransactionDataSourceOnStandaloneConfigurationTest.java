    ...
    AbstractDataSourceWarCapabilityContainerTestCase
{
    ...
    public boolean isSupported(String containerId, ContainerType containerType, Method testMethod)
    {
        ...
        // We exclude GlassFish 7.x, 8.x <nd 9.x as well as WebLogic 12.1.x, 12.2.x, 14.x and 15.x
        // as these don't support XA transaction emulation the way Codehaus Cargo tests it
