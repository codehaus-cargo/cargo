...
public class BundleCapabilityContainerTest extends AbstractCargoTestCase
{
    ...
    public static Test suite() throws Exception
    {
        ...
        // We exclude JBoss 7.2.x, JBoss 7.3.x, JBoss 7.4.x, WildFly 8.x and WildFly 9.x as the
        // default standalone configuration XML for these servers has OSGi support disabled
