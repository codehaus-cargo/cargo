...
public class BundleCapabilityContainerTest extends AbstractCargoTestCase
{
    ...
    public static Test suite() throws Exception
    {
        ...
        // We exclude JBoss 7.2.x, JBoss 7.3.x, JBoss 7.4.x, JBoss 7.5.x, JBoss 8.x, WildFly 8.x,
        // WildFly 9.x and WildFly 10.x as the default standalone configuration XML for these
        // servers has OSGi support disabled
