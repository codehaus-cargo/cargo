...
/**
 * 
 *@version $Id: JBoss6xStandaloneLocalConfiguration.java 1850 2008-12-11 19:30:42Z mwringe $
 */
public class JBoss6xStandaloneLocalConfiguration extends JBossStandaloneLocalConfiguration
{
    ...
    protected void doConfigure(LocalContainer container) throws Exception
    {
        ...
        String[] configFiles = new String[] {"jboss-service.xml", "jboss-logging.xml"};
