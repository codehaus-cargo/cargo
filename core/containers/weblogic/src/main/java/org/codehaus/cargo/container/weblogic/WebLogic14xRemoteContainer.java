...
/**
 * Special container support for the Bea WebLogic 14.x application server. Contains WLST support.
 */
public class WebLogic14xRemoteContainer extends AbstractWebLogicRemoteContainer
{
     ...
     */
    public WebLogic14xRemoteContainer(RuntimeConfiguration configuration)
    {
        super(configuration);
    }
