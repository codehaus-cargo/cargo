 ...
 */
public class ShutdownDomainScriptCommand extends AbstractResourceScriptCommand
{
     ...
     */
    public ShutdownDomainScriptCommand(Configuration configuration, String resourcePath)
    {
    ...
    {
        return "domain/shutdown-domain.py";
    }
}
