 ...
 * @version $Id: $
 */
public class WebLogic9xStandaloneLocalConfigurationCapability extends
    WebLogicStandaloneLocalConfigurationCapability
{
     ...
     */
    public WebLogic9xStandaloneLocalConfigurationCapability()
    {
        super();
        ...
        this.supportsMap.remove(DatasourcePropertySet.DATASOURCE);
    }
}
