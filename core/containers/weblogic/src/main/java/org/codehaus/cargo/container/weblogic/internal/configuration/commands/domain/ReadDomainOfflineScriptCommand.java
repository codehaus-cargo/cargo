...
public class ReadDomainOfflineScriptCommand extends AbstractResourceScriptCommand
{
     ...
     */
    public ReadDomainOfflineScriptCommand(Configuration configuration, String resourcePath)
    {
    ...
    {
        return "domain/read-domain-offline.py";
    }

    @Override
    protected void addConfigurationScriptProperties(Map<String, String> propertiesMap)
    {
        propertiesMap.put("cargo.weblogic.domain.home",
                ((WebLogicConfiguration) getConfiguration()).getDomainHome());
    }
}
