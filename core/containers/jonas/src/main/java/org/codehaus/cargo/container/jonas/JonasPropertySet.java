 ...
 */
public interface JonasPropertySet
{
    /**
     * The JOnAS target server name, defaults to "jonas".
     */
    String JONAS_SERVER_NAME = "cargo.jonas.server.name";

    /**
     * The JOnAS target domain name, defaults to "jonas".
     */
    String JONAS_DOMAIN_NAME = "cargo.jonas.domain.name";
     ...
     * set.
     */
    String JONAS_MEJB_JAAS_FILE = "cargo.jonas.mejb.jaas.file";
     ...
     */
    String JONAS_MEJB_JAAS_ENTRY = "cargo.jonas.mejb.jaas.entry";

    /**
     * For MEJB remote deployment only, the jndi initial context factory, defaults to
     * "org.objectweb.carol.jndi.spi.MultiOrbInitialContextFactory".
     */
    String JONAS_MEJB_JNDI_INIT_CTX_FACT = "cargo.jonas.jndi.initial.context.factory";
     ...
     */
    String JONAS_DEPLOYABLE_IDENTIFIER = "cargo.jonas.deployable.identifier";
     ...
     * details.
     */
    String JONAS_SERVICES_LIST = "cargo.jonas.services.list";

    /**
     * JMS port used by JOnAS.
     */
    String JONAS_JMS_PORT = "cargo.jonas.jms.port";
     ...
     * extension match.
     */
    String JONAS_UNDEPLOY_IGNORE_VERSION = "cargo.jonas.undeploy.ignoreVersion";

    /**
     * Prefix used for configuration properties that will set values on the JOnAS configurator.
     */
    String CONFIGURATOR_PREFIX = "cargo.jonas.configurator.";
}
