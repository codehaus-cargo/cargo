 ...
 * @version $Id$
 */
public class GlassFish2xExistingLocalConfiguration extends AbstractExistingLocalConfiguration
{
    ...
    private static final ConfigurationCapability CAPABILITY =
        new GlassFish2xExistingLocalConfigurationCapability();
     ...
     */
    public GlassFish2xExistingLocalConfiguration(String home)
    {
        super(home);
