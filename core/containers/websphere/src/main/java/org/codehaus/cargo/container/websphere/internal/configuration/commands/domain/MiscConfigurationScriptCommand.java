 ...
 */
public class MiscConfigurationScriptCommand extends AbstractResourceScriptCommand
{
    /**
     ...
     */
    public MiscConfigurationScriptCommand(Configuration configuration, String resourcePath)
    {
