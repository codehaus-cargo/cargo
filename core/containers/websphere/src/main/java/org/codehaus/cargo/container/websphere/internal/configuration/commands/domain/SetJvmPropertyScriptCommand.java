 ...
 */
public class SetJvmPropertyScriptCommand extends AbstractResourceScriptCommand
{
     ...
     */
    public SetJvmPropertyScriptCommand(Configuration configuration, String resourcePath,
    ...
    {
        propertiesMap.put("cargo.websphere.jvm.name", propertyName);
        propertiesMap.put("cargo.websphere.jvm.value", propertyValue);
    }
}
