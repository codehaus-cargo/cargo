 ...
 */
public class SetSessionManagementPropertyScriptCommand extends AbstractResourceScriptCommand
{
    ...
    public SetSessionManagementPropertyScriptCommand(Configuration configuration,
            String resourcePath, String propertyName, String propertyValue)
    {
    ...
    {
        return "domain/set-session-management-property.py";
    }
