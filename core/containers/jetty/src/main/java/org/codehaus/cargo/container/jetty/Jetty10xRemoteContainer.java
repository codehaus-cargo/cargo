 ...
 */
public class Jetty10xRemoteContainer extends AbstractJettyRemoteContainer
{
    /**
     * Unique container id.
     */
     ...
     */
    public Jetty10xRemoteContainer(RuntimeConfiguration configuration)
    {
        super(configuration);
    }
