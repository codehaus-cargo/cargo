 ...
 */
public class Jetty11xRemoteContainer extends AbstractJettyRemoteContainer
{
    /**
     * Unique container id.
     */
     ...
     */
    public Jetty11xRemoteContainer(RuntimeConfiguration configuration)
    {
        super(configuration);
    }
