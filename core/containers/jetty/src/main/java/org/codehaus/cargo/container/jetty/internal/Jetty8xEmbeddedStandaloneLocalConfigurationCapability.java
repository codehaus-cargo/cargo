...
/**
 * Configuration capability for a Jetty 8.x Embedded container.
 * 
 * @version $Id$
 */
public class Jetty8xEmbeddedStandaloneLocalConfigurationCapability extends
        AbstractJettyEmbeddedStandaloneLocalConfigurationCapability
{
     ...
     */
    public Jetty8xEmbeddedStandaloneLocalConfigurationCapability()
    {
        super();
    }
}
