 ...
 */
public class Jetty12xRemoteContainer extends AbstractJettyRemoteContainer
{
    /**
     * Unique container id.
     */
     ...
     */
    public Jetty12xRemoteContainer(RuntimeConfiguration configuration)
    {
        super(configuration);
    }
