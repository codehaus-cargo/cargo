...
/**
 * Remote deployer that uses the remote API to deploy to WildFly 37.x.
 */
public class WildFly37xRemoteDeployer extends AbstractWildFlyRemoteDeployer
{
    /**
     ...
     */
    public WildFly37xRemoteDeployer(RemoteContainer container)
    {
        super(container);
    }
}
