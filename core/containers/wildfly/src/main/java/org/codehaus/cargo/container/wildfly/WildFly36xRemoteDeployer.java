...
/**
 * Remote deployer that uses the remote API to deploy to WildFly 36.x.
 */
public class WildFly36xRemoteDeployer extends AbstractWildFlyRemoteDeployer
{
    /**
     ...
     */
    public WildFly36xRemoteDeployer(RemoteContainer container)
    {
        super(container);
    }
}
