 ...
 */
public class RunBatchScriptCommand extends AbstractWildFlyScriptCommand
{
     ...
     */
    public RunBatchScriptCommand(Configuration configuration, String resourcePath)
    {
