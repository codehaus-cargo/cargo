...
/**
 * Remote deployer that uses the remote API to deploy to WildFly 40.x.
 */
public class WildFly40xRemoteDeployer extends AbstractWildFlyRemoteDeployer
{
    /**
     ...
     */
    public WildFly40xRemoteDeployer(RemoteContainer container)
    {
        super(container);
    }
}
