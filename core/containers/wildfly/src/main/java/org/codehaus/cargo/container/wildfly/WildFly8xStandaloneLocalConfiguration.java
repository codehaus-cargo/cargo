...
import org.codehaus.cargo.container.jboss.JBoss71xStandaloneLocalConfiguration;
 ...
 * @version $Id$
 */
public class WildFly8xStandaloneLocalConfiguration extends JBoss71xStandaloneLocalConfiguration
{
    ...
    /**
     * {@inheritDoc}
     * @see JBoss71xStandaloneLocalConfiguration#doConfigure(LocalContainer)
     */
    @Override
