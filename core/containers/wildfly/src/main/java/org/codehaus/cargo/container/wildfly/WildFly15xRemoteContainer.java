...
public class WildFly15xRemoteContainer extends WildFly14xRemoteContainer
{
    ...
    /**
     * {@inheritDoc}
     * @see WildFly14xRemoteContainer#WildFly14xRemoteContainer(org.codehaus.cargo.container.configuration.RuntimeConfiguration)
     */
    public WildFly15xRemoteContainer(RuntimeConfiguration configuration)
    {
        super(configuration);
    }
