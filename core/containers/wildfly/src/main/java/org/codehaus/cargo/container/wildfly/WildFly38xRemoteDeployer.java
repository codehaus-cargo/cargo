...
/**
 * Remote deployer that uses the remote API to deploy to WildFly 38.x.
 */
public class WildFly38xRemoteDeployer extends AbstractWildFlyRemoteDeployer
{
    /**
     ...
     */
    public WildFly38xRemoteDeployer(RemoteContainer container)
    {
        super(container);
    }
}
