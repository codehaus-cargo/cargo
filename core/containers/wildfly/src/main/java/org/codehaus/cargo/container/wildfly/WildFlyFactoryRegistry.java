...
public class WildFlyFactoryRegistry extends AbstractFactoryRegistry
{
    ...
    protected void register(DeployableFactory deployableFactory)
    {
        ...
        deployableFactory.registerDeployable("wildfly35x", DeployableType.WAR, JBossWAR.class);
        deployableFactory.registerDeployable("wildfly36x", DeployableType.WAR, JBossWAR.class);
        deployableFactory.registerDeployable("wildfly37x", DeployableType.WAR, JBossWAR.class);
        deployableFactory.registerDeployable("wildfly38x", DeployableType.WAR, JBossWAR.class);
        deployableFactory.registerDeployable("wildfly39x", DeployableType.WAR, JBossWAR.class);
        deployableFactory.registerDeployable("wildfly40x", DeployableType.WAR, JBossWAR.class);
        deployableFactory.registerDeployable("wildfly41x", DeployableType.WAR, JBossWAR.class);
    }
    ...
    protected void register(ConfigurationCapabilityFactory configurationCapabilityFactory)
    {
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly31x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly31x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly32x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly32x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly35x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly35x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly36x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly36x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly37x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly37x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly38x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly38x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly39x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly39x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
        ...
        configurationCapabilityFactory.registerConfigurationCapability("wildfly40x",
            ContainerType.INSTALLED, ConfigurationType.STANDALONE,
            WildFly9xStandaloneLocalConfigurationCapability.class);
        configurationCapabilityFactory.registerConfigurationCapability("wildfly40x",
            ContainerType.INSTALLED, ConfigurationType.EXISTING,
    ...
    protected void register(ConfigurationFactory configurationFactory)
    {
        ...
        configurationFactory.registerConfiguration("wildfly31x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly31xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly31x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly31xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly31x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly31xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly32x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly32xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly32x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly32xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly32x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly32xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly33x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly33xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly33x", ContainerType.INSTALLED,
        ...
        configurationFactory.registerConfiguration("wildfly35x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly35xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly35x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly35xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly35x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly35xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly36x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly36xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly36x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly36xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly36x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly36xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly37x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly37xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly37x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly37xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly37x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly37xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly38x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly38xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly38x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly38xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly38x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly38xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly39x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly39xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly39x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly39xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly39x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly39xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly40x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly40xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly40x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly40xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly40x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly40xRuntimeConfiguration.class);

        configurationFactory.registerConfiguration("wildfly41x", ContainerType.INSTALLED,
            ConfigurationType.STANDALONE, WildFly41xStandaloneLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly41x", ContainerType.INSTALLED,
            ConfigurationType.EXISTING, WildFly41xExistingLocalConfiguration.class);
        configurationFactory.registerConfiguration("wildfly41x", ContainerType.REMOTE,
            ConfigurationType.RUNTIME, WildFly41xRuntimeConfiguration.class);
    }
    ...
    protected void register(DeployerFactory deployerFactory)
    {
        ...
        deployerFactory.registerDeployer("wildfly31x", DeployerType.INSTALLED,
            WildFly31xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly31x", DeployerType.REMOTE,
            WildFly31xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly32x", DeployerType.INSTALLED,
            WildFly32xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly32x", DeployerType.REMOTE,
            WildFly32xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly33x", DeployerType.INSTALLED,
        ...
        deployerFactory.registerDeployer("wildfly35x", DeployerType.INSTALLED,
            WildFly35xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly35x", DeployerType.REMOTE,
            WildFly35xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly36x", DeployerType.INSTALLED,
            WildFly36xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly36x", DeployerType.REMOTE,
            WildFly36xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly37x", DeployerType.INSTALLED,
            WildFly37xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly37x", DeployerType.REMOTE,
            WildFly37xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly38x", DeployerType.INSTALLED,
            WildFly38xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly38x", DeployerType.REMOTE,
            WildFly38xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly39x", DeployerType.INSTALLED,
            WildFly39xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly39x", DeployerType.REMOTE,
            WildFly39xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly40x", DeployerType.INSTALLED,
            WildFly40xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly40x", DeployerType.REMOTE,
            WildFly40xRemoteDeployer.class);

        deployerFactory.registerDeployer("wildfly41x", DeployerType.INSTALLED,
            WildFly41xInstalledLocalDeployer.class);
        deployerFactory.registerDeployer("wildfly41x", DeployerType.REMOTE,
            WildFly41xRemoteDeployer.class);
    }
    ...
    protected void register(ContainerFactory containerFactory)
    {
        ...
        containerFactory.registerContainer("wildfly31x", ContainerType.INSTALLED,
            WildFly31xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly31x", ContainerType.REMOTE,
            WildFly31xRemoteContainer.class);

        containerFactory.registerContainer("wildfly32x", ContainerType.INSTALLED,
            WildFly32xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly32x", ContainerType.REMOTE,
            WildFly32xRemoteContainer.class);

        containerFactory.registerContainer("wildfly33x", ContainerType.INSTALLED,
        ...
        containerFactory.registerContainer("wildfly35x", ContainerType.INSTALLED,
            WildFly35xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly35x", ContainerType.REMOTE,
            WildFly35xRemoteContainer.class);

        containerFactory.registerContainer("wildfly36x", ContainerType.INSTALLED,
            WildFly36xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly36x", ContainerType.REMOTE,
            WildFly36xRemoteContainer.class);

        containerFactory.registerContainer("wildfly37x", ContainerType.INSTALLED,
            WildFly37xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly37x", ContainerType.REMOTE,
            WildFly37xRemoteContainer.class);

        containerFactory.registerContainer("wildfly38x", ContainerType.INSTALLED,
            WildFly38xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly38x", ContainerType.REMOTE,
            WildFly38xRemoteContainer.class);

        containerFactory.registerContainer("wildfly39x", ContainerType.INSTALLED,
            WildFly39xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly39x", ContainerType.REMOTE,
            WildFly39xRemoteContainer.class);

        containerFactory.registerContainer("wildfly40x", ContainerType.INSTALLED,
            WildFly40xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly40x", ContainerType.REMOTE,
            WildFly40xRemoteContainer.class);

        containerFactory.registerContainer("wildfly41x", ContainerType.INSTALLED,
            WildFly41xInstalledLocalContainer.class);
        containerFactory.registerContainer("wildfly41x", ContainerType.REMOTE,
            WildFly41xRemoteContainer.class);
    }
    ...
    protected void register(ContainerCapabilityFactory containerCapabilityFactory)
    {
        ...
        containerCapabilityFactory.registerContainerCapability("wildfly30x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly31x",
            WildFlyContainerCapability.class);
        ...
        containerCapabilityFactory.registerContainerCapability("wildfly34x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly35x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly36x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly37x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly38x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly39x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly40x",
            WildFlyContainerCapability.class);
        containerCapabilityFactory.registerContainerCapability("wildfly41x",
            WildFlyContainerCapability.class);
    }
