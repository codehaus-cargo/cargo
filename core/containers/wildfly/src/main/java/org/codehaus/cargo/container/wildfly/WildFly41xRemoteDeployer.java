...
/**
 * Remote deployer that uses the remote API to deploy to WildFly 41.x.
 */
public class WildFly41xRemoteDeployer extends AbstractWildFlyRemoteDeployer
{
    /**
     ...
     */
    public WildFly41xRemoteDeployer(RemoteContainer container)
    {
        super(container);
    }
}
