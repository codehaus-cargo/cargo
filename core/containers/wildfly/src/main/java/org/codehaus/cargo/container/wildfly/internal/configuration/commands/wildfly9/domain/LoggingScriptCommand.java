 ...
 * ========================================================================
 *
 * Codehaus CARGO, copyright 2004-2011 Vincent Massol, 2011-2021 Ali Tokmen.
 *
...
public class LoggingScriptCommand extends AbstractWildFlyScriptCommand
{
    ...
    {
        String cargoLogLevel = getConfiguration().getPropertyValue(GeneralPropertySet.LOGGING);
        String wildFlyLogLevel = WildFlyLogUtils.getWildFlyLogLevel(cargoLogLevel);
        propertiesMap.put("cargo.wildfly.logging", wildFlyLogLevel);
    }
}
